...
<body id="page-top" class="sidebar-toggled">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            @include('layout.nav')
            <div id="content"
                style="background-image: url('{{URL::asset('/img/connexion.jpg')}}');background-size: cover;">
                @include('layout.nav-responsive')
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 mt-4 mb-2 pb-2" style="padding-top:100px;">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="form-group">
                                                <button type="submit"
                                                    class="mt-2 btn float-right btn-success btn-md btn-block">
                                                    Se connecter
                                                </button>
                                            </div>
                                        </form>
