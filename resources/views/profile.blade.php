                    ...
                    <div class="card-body">
                      ...
                      <div class="input-group form-group">
                        ...
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                          name="name" value="{{Auth::User()->name}}" placeholder="nom" required autocomplete="name"
                          autofocus>
                      ...
                      <div class="input-group form-group">
                        ...
                        <input id="first_name" type="text"
                          ...
                          value="{{Auth::User()->first_name}}" required autocomplete="first_name" placeholder="prénom">
